(function () {
    // Функция определения браузеров IE\EDGE
    function detectIE() {
...
// END Polyfill for array from

(function() {
    // Функция определения наличия сенсорного дисплея
    var tigger = 'false';
    ...
    $('body').attr('data-touching', tigger);
}());
  ...
  var Modal = function () {
    ...
    createClass(Modal, [{
      ...
      value: function showModal() {
        ...
        this.modal.classList.add('_is-open');
